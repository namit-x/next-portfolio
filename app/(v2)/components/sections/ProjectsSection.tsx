...
const FEATURED_PROJECTS: FeaturedProject[] = [
  {
    ...
    imageUrl: '/Vesta.webp',
    tags: ['React', 'TypeScript', 'MERN', 'Healthcare'],
  },
  {
    id: 'advance',
    number: '02',
    ...
    impact: 'Shifted the brand presentation toward a more premium, client-ready digital presence.',
    imageUrl: '/Advance.webp',
    tags: ['Next.js', 'Architecture', 'Responsive UI', 'Brand Site'],
  },
  {
    id: 'rag',
    number: '03',
    ...
    year: '2025',
    summary:
      'A local-first retrieval-augmented generation pipeline that transforms YouTube tutorials into a searchable knowledge base using transcription, embeddings, and LLM-powered response generation.',
    impact: 'Engineered a reproducible AI pipeline with resilient batch processing, smart chunking, and low-latency semantic retrieval.',
    imageUrl: '/RAG.webp',
    tags: ['Python', 'Whisper', 'bge-m3', 'Llama 3.2'],
  },
  {
    id: 'openup',
    number: '04',
    ...
    tags: ['WebRTC', 'Video Calling', 'Calendar Integration', 'Matching System'],
  },
]
